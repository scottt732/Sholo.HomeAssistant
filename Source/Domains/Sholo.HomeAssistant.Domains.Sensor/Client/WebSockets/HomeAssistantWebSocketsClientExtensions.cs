...
{
    public static IAsyncEnumerable<IEventMessage<StateChangePayload<SensorEntityState>>> GetSensorStateChangesAsync(
        this IHomeAssistantWebSocketsClient client,
        Func<IEventMessage<StateChangePayload<SensorEntityState>>, bool>? predicate = null,
